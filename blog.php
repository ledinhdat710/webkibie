        ...
        <div class="fix-col col-md-3 col-sm-6 col-xs-6 col-6">
          <div class="product-block">
            <div class="product-img fade-box">
              <a href="detailblog.php?blog_id=<?php echo $row['blog_id']; ?>" title="<?php echo $row['blog_name'] ?>" class="img-resize">
            ...
            <div class="product-detail clearfix">
              <div>
                <a style=" color: black;
              font-size: 16px;text-decoration: none;" href="detailblog.php?blog_id=<?php echo $row['blog_id']; ?>" title="<?php echo $row['blog_name'] ?>" inspiration pack> <?php echo $row['blog_name']; ?>
                </a>
              </div>
            </div>
          </div>
